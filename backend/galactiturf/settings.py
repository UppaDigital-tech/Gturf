"""
Django settings for galactiturf project.
...
# CORS Settings
CORS_ALLOWED_ORIGINS = config('CORS_ALLOWED_ORIGINS', default='http://localhost:3000,https://galactiturf.vercel.app').split(',')
