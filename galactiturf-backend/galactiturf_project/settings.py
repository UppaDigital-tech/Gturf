"""
Django settings for galactiturf_project project.
...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-g2$q(9x$4@e(=2*wct!#-k-u*x&%n^g-)mjs7@@r6or9-pjh$6')
...
ROOT_URLCONF = 'galactiturf_project.urls'
...
WSGI_APPLICATION = 'galactiturf_project.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': config('DB_NAME', default='galactiturf_db'),
